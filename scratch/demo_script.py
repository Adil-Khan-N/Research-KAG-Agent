"""
Demo script — 3-5 minute walkthrough for interviews.
Run this to practice the demo flow.
Copy the queries below for live demo.
"""
...
print(DEMO_SCRIPT)
# Save to file (UTF-8)
with open("docs/demo_script.md", "w", encoding="utf-8") as f:
    f.write(DEMO_SCRIPT.replace("╔", "#").replace("╚", ""))

print("\n✓ Saved to docs/demo_script.md")