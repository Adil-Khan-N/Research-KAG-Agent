...
Used for A/B comparison in RAGAS evaluation.
"""
...
from retrieval.search import SearchResult, get_model, embed_query
...
def search_adaptive(
    ...
    logger.info(
        f"Adaptive search: {len(rows)} results in {elapsed}ms"
    )
